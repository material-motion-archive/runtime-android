 ...
 *
 * <p>
 * Optional APIs can be implemented by implementing the <code>*Plan</code> interfaces.
 * Libraries that consume Plans can also add optional APIs in its own package.
 *
 * @see <a href="https://material-motion.gitbooks.io/material-motion-starmap/content/specifications/runtime/plan.html">The Plan specificiation</a>
 * @see Object#clone()
 */
